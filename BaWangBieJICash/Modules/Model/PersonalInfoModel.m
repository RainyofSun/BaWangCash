...
+ (instancetype)ACModel_withDict:(NSDictionary *)dict
{
    ...
    if ([dict[@"TrtMc"] isKindOfClass:[NSString class]]) {
        model.pc_TrtMc = ((NSString *)dict[@"TrtMc"]);
    }

    if ([dict[@"fmHnv"] isKindOfClass:[NSString class]]) {
        model.pc_fmHnv = ((NSString *)dict[@"fmHnv"]);
    }
    ...
    if ([dict[@"counterclockwise"] isKindOfClass:[NSArray class]]) {
        ...
        for (NSDictionary *sub_dict in (NSArray *)dict[@"counterclockwise"]) {
            ...
            PC_UserInfoModel_Counterclockwise *sub_model = [PC_UserInfoModel_Counterclockwise ACModel_withDict:sub_dict];
...
@interface PC_UserInfoModel_Counterclockwise ()

@end

@implementation PC_UserInfoModel_Counterclockwise


+ (instancetype)ACModel_withDict:(NSDictionary *)dict
{

    PC_UserInfoModel_Counterclockwise *model = [PC_UserInfoModel_Counterclockwise new];
    ...
    if ([dict[@"darkstar"] isKindOfClass:[NSArray class]]) {
        ...
        for (NSDictionary *sub_dict in (NSArray *)dict[@"darkstar"]) {
            ...
            PC_PersonInfoModel_Counterclockwise_Darkstar *sub_model = [PC_PersonInfoModel_Counterclockwise_Darkstar ACModel_withDict:sub_dict];
            [counterclockwise_modelArray addObject:sub_model];
        }
        model.pc_darkstar = counterclockwise_modelArray;
    }
...
@interface PC_PersonInfoModel_Counterclockwise_Darkstar ()

@end

@implementation PC_PersonInfoModel_Counterclockwise_Darkstar


+ (instancetype)ACModel_withDict:(NSDictionary *)dict
{

    PC_PersonInfoModel_Counterclockwise_Darkstar *model = [PC_PersonInfoModel_Counterclockwise_Darkstar new];
